...
const VOICE_GATEWAY_URL =
  process.env.NEXT_PUBLIC_KAI_VOICE_GATEWAY_URL ||
  "https://kai-voice-gateway.your-domain.workers.dev";

// Auth token for Kai gateway (JWT from server-side or env)
const KAI_AUTH_TOKEN =
  process.env.NEXT_PUBLIC_KAI_AUTH_TOKEN || "";
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <KaiVoiceOrb
        ...
        authToken={KAI_AUTH_TOKEN || undefined}
        allowedActions={[
          "read_project_status",
          "summarize_blockers",
