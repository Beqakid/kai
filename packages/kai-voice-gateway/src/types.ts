...
export const VALID_ROLES = [
  ...
  'customer',
  'viewer',
  // Phase 11 Phase 2: App-specific roles
  'caregiver',
  'client',
  'agency-admin',
  'contributor',
...
export const ALLOWED_ACTIONS_REGISTRY: Record<AppId, Record<UserRole, readonly string[]>> = {
  ...
  carehia: {
    ...
    viewer: ['view'],
    caregiver: ['view', 'edit', 'manage-schedules'],
    client: ['view', 'view-schedules'],
    'agency-admin': ['view', 'edit', 'manage-clients', 'manage-schedules'],
    contributor: ['view'],
    reviewer: ['view'],
    driver: ['view'],
    'public-user': ['view'],
